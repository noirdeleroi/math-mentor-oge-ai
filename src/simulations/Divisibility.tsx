...
const DivisionGame: React.FC = () => {
  ...
  return (
    <div
      className="division-game relative w-full h-full overflow-hidden flex flex-col"
      style={{
    ...
    >
      ...
      {/* Поле игры */}
      <div className="relative z-10 flex-1 flex flex-col px-3 md:px-4 pb-4">
...
function placePositions(count: number): { top: number; left: number }[] {
  ...
  const bounds = { topMin: 6, topMax: 88, leftMin: 4, leftMax: 94 };
