...
const MD = `
**Главное рабочее место — это чат.** Попасть в него можно, кликнув по названию курса вверху. В чате ты можешь задавать любые вопросы так же, как на занятии с учителем. чат Это твой Воркспейс: есть навигация по всем разделам. Вот краткое руководство, чтобы быстро разобраться:
