...
const EgemathprofRevision: React.FC = () => {
  const { user } = useAuth();
      ...
      <div className="min-h-screen text-white relative" style={{ background: 'linear-gradient(135deg, #1a1f36 0%, #2d3748 50%, #1a1f36 100%)' }}>
        <div className="container mx-auto px-4 py-8 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="mb-6">
              <Button variant="ghost" size="sm" className="hover:bg-white/20 text-white" onClick={() => navigate('/egemathprof-practice')}>
            ...
            <Card className="bg-white/95 text-[#1a1f36] rounded-2xl shadow-xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <Button onClick={handleBackToMain} variant="outline" className="flex-1 border-white/40 text-[#1a1f36] hover:bg-white/90">
                    Назад
                  </Button>
                </div>
              </CardContent>
            ...
            {sessionOver ? (
              <Card className="bg-white/95 text-[#1a1f36] rounded-2xl shadow-xl">
                <CardContent className="p-8 text-center">
                  ...
                  <h2 className="text-2xl font-bold mb-2">Все готово!</h2>
                  <p className="text-gray-600 mb-6">
                    {skillsForPractice.length === 0 
                      ? 'Навыков для повторения пока нет. Попробуйте пройти диагностику или решить задачи.'
                      : 'Вы прошли все уникальные вопросы. Приходите позже за новыми!'}
                  </p>
                  <Button onClick={handleBackToMain} className="bg-gradient-to-r from-yellow-500 to-emerald-500 hover:from-yellow-600 hover:to-emerald-600 text-[#1a1f36]">
                    Назад к практике
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl shadow-xl">
                <CardContent className="p-6">
                  <div className="flex items-center justify-center">
                    <RefreshCw className="w-6 h-6 mr-2 animate-spin text-white/80" />
                    <span className="text-white/80">Загрузка вопроса...</span>
                  </div>
                </CardContent>
              </Card>
            )}
...
export default EgemathprofRevision;
