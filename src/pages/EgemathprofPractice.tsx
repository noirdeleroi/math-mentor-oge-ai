...
const EgemathprofPractice = () => {
  ...
  const mockExam = {
    title: "Пробный экзамен ЕГЭ (Профиль)",
    description: "Полный экзамен — 19 вопросов (3:55:00)",
    icon: ClipboardList,
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl md:text-6xl font-display font-bold mb-4 bg-gradient-to-r from-gold to-sage bg-clip-text text-transparent">
              Практика ЕГЭ Профильная Математика
            </h1>
