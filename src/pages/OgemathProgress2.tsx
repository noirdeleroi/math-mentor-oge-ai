...
function LegendItem({
  ...
  return <span className="inline-flex items-center gap-2 text-[11px] text-gray-600 bg-gray-50/80 px-2 py-1 rounded-lg border border-gray-200/50">
  ...
  if (error) {
    return <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center space-y-4">
          ...
          <button onClick={() => navigate('/ogemath-progress2')} className="bg-primary text-primary-foreground px-4 py-2 rounded-md hover:bg-primary/90 transition-colors">
